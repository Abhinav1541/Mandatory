...
Original file is located at
    https://colab.research.google.com/drive/1niqCLAh8TZ8yVsNMaLsqAE-m-DxfITMP
"""
...
class introduction:
  ...
  def my_intro(self):
    ...
    print("I am a", self.year_of_study, get_super('nd'), "year", self.department ,"undergraduate at", self.college)
